...
const Dashboard: React.FC = () => {
  ...
  // Check post-assessment completion
  ...
  // Check module completion with correct session ID mapping
  const checkModuleCompletion = async (userId: string): Promise<number[]> => {
    try {
      ...
      // Session ID ranges based on actual database structure
...
EOF# Backup the broken file
cp app/dashboard/page.tsx app/dashboard/page.tsx.BROKEN_BACKUP

# Create completely clean dashboard with correct session ID mapping
