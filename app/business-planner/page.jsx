...
const IBAMBusinessPlanner = () => {
  ...
  // Simple financial section for now
  const renderFinancial = () => (
    <div className="space-y-6">
      <ThreeFishHeader fishApproach="giveFish" />
      <div className="text-center py-12">
        <div className="text-6xl mb-4">💰</div>
        <h3 className="text-xl font-bold mb-2">Financial Section Coming Soon!</h3>
        <p className="text-gray-600">We're building an amazing financial planning tool for you.</p>
      </div>
    </div>
  );
