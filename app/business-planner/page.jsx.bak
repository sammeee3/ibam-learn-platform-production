...
const IBAMBusinessPlanner = () => {
  ...
  // Complete Financial Section Implementation
    ...
    <div className="space-y-8">
          ...
          <FieldWithTooltip fieldKey="bootstrapBudget" label="Bootstrap Budget" required>
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => handleInputChange('financial', 'bootstrapBudget', parseFloat(e.target.value) || 0)}
                className="w-full pl-8 pr-3 py-3 border rounded-lg text-lg font-bold focus:ring-2 focus:outline-none"
                style={{ borderColor: colors.border }}
                placeholder="5000"
                min="0"
                step="100"
          ...
          {Object.entries({
            ...
            <FieldWithTooltip key={key} fieldKey={key} label={label}>
              <div className="relative">
                ...
                <input
                  type="number"
                  value={formData.financial.startupCosts[key]}
                  onChange={(e) => handleInputChange('financial', 'startupCosts', parseFloat(e.target.value) || 0, key)}
                  className="w-full pl-8 pr-3 py-3 border rounded-lg focus:ring-2 focus:outline-none"
                  style={{ borderColor: colors.border }}
                  placeholder="0"
                  min="0"
                  step="50"
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          <div className="flex justify-between items-center">
            ...
            <span className="text-xl font-bold" style={{ color: colors.primary }}>
              {formatCurrencyString(Object.values(formData.financial.startupCosts).reduce((sum, val) => sum + (parseFloat(val) || 0), 0))}
            </span>
          </div>
          {Object.values(formData.financial.startupCosts).reduce((sum, val) => sum + (parseFloat(val) || 0), 0) > formData.financial.bootstrapBudget && (
            <div className="mt-2 text-sm text-red-700 font-medium">
              ⚠️ Over budget by {formatCurrencyString(Object.values(formData.financial.startupCosts).reduce((sum, val) => sum + (parseFloat(val) || 0), 0) - formData.financial.bootstrapBudget)}
            </div>
          )}
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl p-6 border" style={{ borderColor: colors.border }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {Object.entries({
            ...
            bankFees: "Bank & Payment Fees",
            software: "Software Subscriptions",
            ownerSalary: "Your Salary",
            ...
            <FieldWithTooltip key={key} fieldKey={key} label={label}>
              <div className="relative">
                ...
                <input
                  type="number"
                  value={formData.financial.fixedCosts[key]}
        ...
        <div className="mt-6">
          <div className="flex justify-between items-center mb-3">
            <h5 className="font-medium">Custom Fixed Costs</h5>
            <button
          ...
          {(formData.financial.fixedCosts.custom || []).map((item, index) => (
            <div key={item.id} className="flex space-x-2 mb-2">
              <input
                type="text"
                value={item.name}
                onChange={(e) => {
                  const newCustom = [...formData.financial.fixedCosts.custom];
                  newCustom[index].name = e.target.value;
                  handleInputChange('financial', 'fixedCosts', newCustom, 'custom');
                }}
              ...
              <div className="relative w-32">
                ...
                <input
                  ...
                  onChange={(e) => {
                    const newCustom = [...formData.financial.fixedCosts.custom];
                    newCustom[index].amount = parseFloat(e.target.value) || 0;
                    handleInputChange('financial', 'fixedCosts', newCustom, 'custom');
                  }}
              ...
              <button
                onClick={() => removeCustomCost('fixedCosts', item.id)}
            ...
            <span className="text-xl font-bold" style={{ color: colors.secondary }}>
              {formatCurrencyString(
                Object.entries(formData.financial.fixedCosts)
                  .filter(([key]) => key !== 'custom')
                  .reduce((sum, [key, val]) => sum + (parseFloat(val) || 0), 0) +
                (formData.financial.fixedCosts.custom || []).reduce((sum, cost) => sum + (parseFloat(cost.amount) || 0), 0)
              )}
            </span>
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl p-6 border" style={{ borderColor: colors.border }}>
          ...
          {Object.entries({
            ...
            <FieldWithTooltip key={key} fieldKey={key} label={label}>
              <div className="relative">
                ...
                <input
                  type="number"
                  value={formData.financial.variableCosts[key]}
        ...
        <div className="mt-6 p-4 bg-orange-50 rounded-lg">
          <div className="flex justify-between items-center">
            <span className="font-bold">Total Monthly Variable Costs:</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      value={product.name}
                      onChange={(e) => {
                        const newProducts = [...formData.financial.productsServices];
                        newProducts[index].name = e.target.value;
                        handleInputChange('financial', 'productsServices', newProducts);
                      }}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const newProducts = [...formData.financial.productsServices];
                        newProducts[index].costOfGoods = parseFloat(e.target.value) || 0;
                        handleInputChange('financial', 'productsServices', newProducts);
                      }}
                      className="w-full p-2 border rounded text-sm"
                      placeholder="0"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const newProducts = [...formData.financial.productsServices];
                        newProducts[index].monthlyQuantity = parseInt(e.target.value) || 0;
                        handleInputChange('financial', 'productsServices', newProducts);
                      }}
                      className="w-full p-2 border rounded text-sm"
                      placeholder="0"
                  ...
                  <div className="flex items-end">
                    <button
                      onClick={() => {
                        const newProducts = formData.financial.productsServices.filter((_, i) => i !== index);
                        handleInputChange('financial', 'productsServices', newProducts);
                      }}
          ...
          <div className="mt-6 p-4 bg-green-50 rounded-lg">
            <div className="flex justify-between items-center">
              ...
              <span className="text-xl font-bold" style={{ color: colors.success }}>
                {formatCurrencyString(
                  formData.financial.productsServices.reduce((sum, product) => {
                    const price = parseFloat(product.price) || 0;
                    const quantity = parseInt(product.monthlyQuantity) || 0;
                    return sum + (price * quantity);
                  }, 0)
      ...
      {formData.financial.productsServices.length > 0 && (
        <div className="bg-white rounded-xl p-6 border" style={{ borderColor: colors.border }}>
          ...
          {/* Simple projection table for first 12 months */}
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {calculateProjections().slice(0, 12).map((month, index) => {
          ...
          {/* Break-even analysis */}
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <h5 className="font-bold mb-2" style={{ color: colors.primary }}>Break-Even Analysis</h5>
            <div className="text-sm space-y-1">
              {(() => {
                const projections = calculateProjections();
                const breakEvenMonth = projections.findIndex(month => month.profit > 0);
                const totalStartupCosts = Object.values(formData.financial.startupCosts)
                  .reduce((sum, val) => sum + (parseFloat(val) || 0), 0);
                  
                return (
                  <>
                    <div>Break-even month: {breakEvenMonth >= 0 ? `Month ${breakEvenMonth + 1}` : 'Beyond 36 months'}</div>
                    <div>Total investment needed: {formatCurrencyString(totalStartupCosts)}</div>
                    <div>Monthly fixed costs: {formatCurrencyString(
                      Object.entries(formData.financial.fixedCosts)
                        .filter(([key]) => key !== 'custom')
                        .reduce((sum, [key, val]) => sum + (parseFloat(val) || 0), 0)
                    )}</div>
  ...
  // Simple placeholder sections for other sections not yet implemented
  const renderGenericSection = (sectionTitle) => (
    <div className="space-y-6">
      <div className="text-center py-12">
        <div className="text-6xl mb-4">🚧</div>
        <h3 className="text-xl font-bold mb-2">{sectionTitle} Section Under Construction</h3>
  ...
  const renderCurrentSection = () => {
    switch (sections[currentSection].id) {
      ...
      case 'legalCompliance':
        return renderGenericSection('Legal Compliance');
      case 'operationsPlanning':
        return renderGenericSection('Operations Planning');
      case 'implementationPlan':
        return renderGenericSection('Implementation Plan');
      case 'riskManagement':
        return renderGenericSection('Risk Management');
      case 'kpiDashboard':
        return renderGenericSection('KPI Dashboard');
      case 'scalingFramework':
        return renderGenericSection('Scaling Framework');
      case 'faithMetrics':
        return renderGenericSection('Faith Metrics');
      case 'winsTracking':
        return renderGenericSection('Wins Tracking');
      case 'coachingReviews':
        return renderGenericSection('Coaching Reviews');
      default:
        return renderGenericSection('Unknown Section');
    }
  };
