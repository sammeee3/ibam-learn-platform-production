...
const PostAssessment: React.FC = () => {
  ...
  // Post-assessment questions (same as pre-assessment for comparison)
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .insert({
          ...
          assessment_id: '4a70a585-ae69-4b93-92d0-a03ba789d853', // Post-assessment ID
          responses: responses,
  ...
  // Handle continue back to final session
  const handleContinue = () => {
    window.location.href = '/modules/5/sessions/3';
  };
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center">
        <div className="bg-white rounded-lg shadow-xl p-8 max-w-2xl mx-4">
          <div className="text-center">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-4">Course Complete! 🎉</h1>
            <p className="text-gray-600 mb-8 text-lg">
              Congratulations! You've successfully completed the Faith-Driven Business program and earned your certificate. 
              Your transformation journey is now documented and your business is equipped for Kingdom impact!
            </p>
            <button
              onClick={handleContinue}
              className="bg-green-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-green-700 transition-colors flex items-center mx-auto"
            >
              Return to Course
        ...
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Post-Course Assessment</h1>
                <p className="text-gray-600">Measure your transformation and growth</p>
              </div>
            </div>
...
// File: /app/assessment/post/page.tsx
// This handles the post-course assessment for completion tracking