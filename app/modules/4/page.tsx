...
const Module4Financial: React.FC = () => {
  ...
  const loadModuleData = async () => {
    try {
      ...
      // Get user progress for Module 4
        ...
        const mockSessions: SessionData[] = [
          {
            ...
            subtitle: "Multiple Sources and Strategies for Capital",
            isCompleted: false,
            isLocked: false,
          ...
          },
          {
            ...
            subtitle: "Stewardship Principles for Financial Planning",
            isCompleted: false,
            isLocked: true,
          ...
          },
          {
            ...
            subtitle: "Understanding What Investors Expect",
            isCompleted: false,
            isLocked: true,
            isCurrentSession: false,
            completion_percentage: 0
          },
          {
            id: 17,
            session_number: 4,
            title: "Listening to Your Business",
            subtitle: "Financial Data and Metrics Analysis",
            isCompleted: false,
            isLocked: true,
            isCurrentSession: false,
            completion_percentage: 0
  ...
  const ModuleProgressHeader: React.FC = () => {  
    return (  
      <div className="bg-gradient-to-r from-orange-400 to-orange-600 text-white shadow-lg">  
          ...
          <div className="flex items-center justify-between">  
            <div className="flex items-center">  
              ...
              <div>  
                ...
                <p className="text-white/90 text-lg">Steward resources with biblical wisdom for sustainable growth</p>  
              </div>  
            </div>  
    ...
    return (  
      <div className="bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl shadow-lg p-6 mb-6">  
        <div className="flex items-center justify-between">  
          ...
          <button  
            onClick={() => window.location.href = `/modules/4/sessions/${currentSession.id}`}
              ...
              <div>  
                ...
                <ul className="space-y-2">  
                  <li className="flex items-start">  
                    ...
                    <span className="text-gray-600 text-sm">Multiple funding sources and strategies for your business</span>  
                  </li>  
                  <li className="flex items-start">  
                    <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Biblical budgeting principles for sustainable growth</span>  
                  </li>  
                  <li className="flex items-start">  
                    <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Understanding investor requirements and expectations</span>  
                  </li>  
                  <li className="flex items-start">  
                    <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">How to listen to your business through financial data</span>  
                  </li>  
                </ul>  
              </div>
              ...
              <div>  
                ...
                <ul className="space-y-2">  
                  <li className="flex items-start">  
                    ...
                    <span className="text-gray-600 text-sm">Clear funding strategy for your business launch</span>  
                  </li>  
                  <li className="flex items-start">  
                    <Award className="w-4 h-4 text-blue-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Biblical framework for financial stewardship</span>  
                  </li>  
                  <li className="flex items-start">  
                    <Award className="w-4 h-4 text-blue-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Professional budget and financial projections</span>  
                  </li>  
                  <li className="flex items-start">  
                    <Award className="w-4 h-4 text-blue-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Skills to monitor and adjust financial performance</span>  
                  </li>  
                </ul>  
              </div>  
            </div>

            <div className="mt-6 bg-gradient-to-r from-orange-50 to-yellow-50 border-l-4 border-orange-400 rounded-r-xl p-4">  
              <div className="flex items-center">  
                <Clock className="w-5 h-5 text-orange-600 mr-3" />  
                <div>  
                  <h4 className="font-semibold text-orange-800">Time Commitment</h4>  
                  <p className="text-orange-600 text-sm">4 sessions • 20-28 minutes each • Financial templates and tools included</p>  
                </div>  
              </div>  
            </div>  
          </div>  
        ...
        <div className="grid gap-4">  
          {sessions.map((session) => (  
            <div  
              ...
              `}  
              onClick={() => !session.isLocked && (window.location.href = `/modules/4/sessions/${session.session_number}`)}
            >  
              <div className="p-6">  
                <div className="flex items-center justify-between">  
                    ...
                    <div className="flex-1">  
                      <div className="flex items-start justify-between mb-2">  
                        <h3 className={`font-semibold text-lg ${  
                          ...
                          session.isCurrentSession ? 'text-orange-800' :  
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading Module 4...</p>
        </div>
      </div>
    );
  }
...
export default Module4Financial;