...
const Module3Marketing: React.FC = () => {
  ...
  const loadModuleData = async () => {
    try {
      ...
      // Get user progress for Module 3
      ...
      if (!sessionsData || sessionsData.length === 0) {
        ...
        const mockSessions: SessionData[] = [
          ...
          },
          {
            id: 10,
            session_number: 2,
            title: "5 Step Selling Process",
            subtitle: "Ethical Sales and Customer Service",
            isCompleted: false,
            isLocked: true,
          ...
          },
          {
            ...
            subtitle: "Understanding Customer Needs and Desires",
            isCompleted: false,
            isLocked: true,
            isCurrentSession: false,
            completion_percentage: 0
          },
          {
            ...
            subtitle: "Target Customer Analysis and Engagement",
            isCompleted: false,
            isLocked: true,
            isCurrentSession: false,
            completion_percentage: 0
          },
          {
            ...
            subtitle: "Competitive Analysis for Strategic Advantage",
            isCompleted: false,
            isLocked: true,
            isCurrentSession: false,
            completion_percentage: 0
  ...
  const ModuleProgressHeader: React.FC = () => {  
    return (  
      <div className="bg-gradient-to-r from-purple-400 to-purple-600 text-white shadow-lg">  
            ...
            <div className="flex items-center">  
              ...
              <div>  
                <h1 className="text-3xl md:text-4xl font-bold mb-2">  
                  Module 3: Marketing Excellence  
                </h1>  
                <p className="text-white/90 text-lg">Master biblical marketing and sales strategies that serve customers</p>  
              </div>  
            </div>  
    ...
    return (  
      <div className="bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl shadow-lg p-6 mb-6">  
        <div className="flex items-center justify-between">  
          ...
          <button  
            onClick={() => window.location.href = `/modules/3/sessions/${currentSession.id}`}
              ...
              <div>  
                ...
                <ul className="space-y-2">  
                  <li className="flex items-start">  
                    ...
                    <span className="text-gray-600 text-sm">The Marketing Triangle methodology for customer connection</span>  
                  </li>  
                  <li className="flex items-start">  
                    <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">5-step selling process that serves rather than manipulates</span>  
                  </li>  
                  <li className="flex items-start">  
                    <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Comprehensive market research techniques and tools</span>  
                  </li>  
                  <li className="flex items-start">  
                    <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Understanding your target market and customer personas</span>  
                  </li>  
                  <li className="flex items-start">  
                    <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Competitive analysis for strategic positioning</span>  
                  </li>  
                </ul>  
              </div>
              ...
              <div>  
                ...
                <ul className="space-y-2">  
                  <li className="flex items-start">  
                    ...
                    <span className="text-gray-600 text-sm">Marketing strategy that aligns with biblical values</span>  
                  </li>  
                  <li className="flex items-start">  
                    <Award className="w-4 h-4 text-blue-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Sales process that builds genuine relationships</span>  
                  </li>  
                  <li className="flex items-start">  
                    <Award className="w-4 h-4 text-blue-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Clear understanding of your ideal customers</span>  
                  </li>  
                  <li className="flex items-start">  
                    <Award className="w-4 h-4 text-blue-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Competitive advantage through market research</span>  
                  </li>  
                  <li className="flex items-start">  
                    <Award className="w-4 h-4 text-blue-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Marketing plan integrated into your business planner</span>  
                  </li>  
                </ul>  
              </div>  
            </div>

            <div className="mt-6 bg-gradient-to-r from-purple-50 to-pink-50 border-l-4 border-purple-400 rounded-r-xl p-4">  
              <div className="flex items-center">  
                <Clock className="w-5 h-5 text-purple-600 mr-3" />  
                <div>  
                  <h4 className="font-semibold text-purple-800">Time Commitment</h4>  
                  <p className="text-purple-600 text-sm">5 sessions • 20-25 minutes each • Practical tools and templates included</p>  
                </div>  
              </div>  
            </div>  
          </div>  
        ...
        <div className="grid gap-4">  
          {sessions.map((session) => (  
            <div  
              ...
              `}  
              onClick={() => !session.isLocked && (window.location.href = `/modules/3/sessions/${session.session_number}`)}
            >  
              <div className="p-6">  
                <div className="flex items-center justify-between">  
                    ...
                    <div className="flex-1">  
                      <div className="flex items-start justify-between mb-2">  
                        <h3 className={`font-semibold text-lg ${  
                          ...
                          session.isCurrentSession ? 'text-purple-800' :  
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading Module 3...</p>
        </div>
      </div>
    );
  }
...
export default Module3Marketing;