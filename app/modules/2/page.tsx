...
const Module2SuccessFailure: React.FC = () => {
  ...
  const loadModuleData = async () => {
    try {
      ...
      // Get user progress for Module 2
      ...
      if (!sessionsData || sessionsData.length === 0) {
        ...
        const mockSessions: SessionData[] = [
          ...
          },
          {
            id: 26,
            session_number: 2,
            title: "Reasons for Success - Faith-Driven Principles",
            subtitle: "Biblical Foundations for Sustainable Business Success",
            isCompleted: false,
            isLocked: true,
          ...
          },
          {
            id: 27,
            session_number: 3,
            title: "Knowing God's Will - Divine Guidance for Business Decisions",
            subtitle: "Partnership with the Creator in Business Strategy",
            isCompleted: false,
            isLocked: true,
            isCurrentSession: false,
            completion_percentage: 0
          },
          {
            ...
            subtitle: "Seamless Integration of Faith and Business Excellence",
            isCompleted: false,
            isLocked: true,
            isCurrentSession: false,
            completion_percentage: 0
  ...
  const ModuleProgressHeader: React.FC = () => {  
    return (  
      <div className="bg-gradient-to-r from-green-400 to-green-600 text-white shadow-lg">  
            ...
            <div className="flex items-center">  
              ...
              <div>  
                <h1 className="text-3xl md:text-4xl font-bold mb-2">  
                  Module 2: Success and Failure Factors  
                </h1>  
                <p className="text-white/90 text-lg">Learn what makes businesses thrive or fail in God's design</p>  
              </div>  
            </div>  
    ...
    return (  
      <div className="bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl shadow-lg p-6 mb-6">  
        <div className="flex items-center justify-between">  
          ...
          <button  
            onClick={() => window.location.href = `/modules/2/sessions/${currentSession.id}`}
              ...
              <div>  
                ...
                <ul className="space-y-2">  
                  <li className="flex items-start">  
                    ...
                    <span className="text-gray-600 text-sm">Common reasons why faith-driven businesses fail</span>  
                  </li>  
                  <li className="flex items-start">  
                    <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Key factors that lead to sustainable business success</span>  
                  </li>  
                  <li className="flex items-start">  
                    <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">How to discern God's will for your business decisions</span>  
                  </li>  
                  <li className="flex items-start">  
                    <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Building godly character that sustains business growth</span>  
                  </li>  
                </ul>  
              </div>
              ...
              <div>  
                ...
                <ul className="space-y-2">  
                  <li className="flex items-start">  
                    ...
                    <span className="text-gray-600 text-sm">Avoid common pitfalls that destroy businesses</span>  
                  </li>  
                  <li className="flex items-start">  
                    <Award className="w-4 h-4 text-blue-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Implement proven success strategies from Scripture</span>  
                  </li>  
                  <li className="flex items-start">  
                    <Award className="w-4 h-4 text-blue-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Clear framework for seeking God's guidance</span>  
                  </li>  
                  <li className="flex items-start">  
                    <Award className="w-4 h-4 text-blue-500 mr-2 mt-0.5 flex-shrink-0" />  
                    <span className="text-gray-600 text-sm">Character foundation for long-term sustainability</span>  
                  </li>  
                </ul>  
              </div>  
            </div>

            <div className="mt-6 bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-400 rounded-r-xl p-4">  
              <div className="flex items-center">  
                <Clock className="w-5 h-5 text-green-600 mr-3" />  
                <div>  
                  <h4 className="font-semibold text-green-800">Time Commitment</h4>  
                  <p className="text-green-600 text-sm">4 sessions • 18-22 minutes each • Learn from real-world examples</p>  
                </div>  
              </div>  
            </div>  
          </div>  
        ...
        <div className="grid gap-4">  
          {sessions.map((session) => (  
            <div  
              ...
              `}  
              onClick={() => !session.isLocked && (window.location.href = `/modules/2/sessions/${session.session_number}`)}
            >  
              <div className="p-6">  
                <div className="flex items-center justify-between">  
                    ...
                    <div className="flex-1">  
                      <div className="flex items-start justify-between mb-2">  
                        <h3 className={`font-semibold text-lg ${  
                          ...
                          session.isCurrentSession ? 'text-green-800' :  
...
export default Module2SuccessFailure;