            ...
            <div className="bg-white rounded-2xl shadow-xl p-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-center text-sm text-slate-600 pt-4 border-t">
                  <p>Questions? Contact Jeff & Julie at <a href="mailto:jeff.julie@ibam.org" className="text-teal-600 hover:underline">jeff.julie@ibam.org</a></p>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
              ...
              <div className="text-center md:text-right space-y-2">
                ...
                <div className="text-sm text-slate-300">
                  Email: <a href="mailto:hello@ibam.org" className="text-teal-400 hover:text-teal-300">hello@ibam.org</a>
                </div>
                <div className="text-sm text-slate-300">
