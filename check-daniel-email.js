...
async function checkDanielEmail() {
  const emailToCheck = 'daniel.a.lilley@gmail.com';
  ...
  try {
    ...
    if (userProfile && authUser) {
      ...
      console.log('');
      console.log('💡 TO ADD THIS USER:');
      console.log('1. Add them to System.io with tag "IBAM Impact Members"');
      console.log('2. Or manually create account in database');
      console.log('3. Or use direct registration on the platform');
    }
